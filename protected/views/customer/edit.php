<form id="customerAddForm" method="post" >
    <table>
        ...
        <tr  >
            <td>姓名</td>
            <td >
                <input type="text" name="name" value="<?=CHtml::encode($customer['customer_name']) ?>" maxlength="50"  placeholder="必填" />
            </td>
        </tr>
        <tr class="odd-row">
            <td >電話1</td>
            <td >
                <input type="text" name="tel1" value="<?=CHtml::encode($customer['customer_tel1']) ?>" maxlength="20"/>
            </td>
        </tr>
        <tr  >
            <td>電話2</td>
